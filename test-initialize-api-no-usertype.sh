...
# Test script for /users/initialize API endpoint without userType
# This tests what happens when we don't send userType in the request

echo "Testing /users/initialize API endpoint without userType..."
echo "========================================================="
...
echo "Making API request without userType..."
echo "Endpoint: $API_URL"
echo ""

# Make the API call without userType
curl -i --insecure \
  -X POST "$API_URL" \
